...
Este programa automatiza a extração de informações sobre itens de solicitação de bens de uso individual a partir de documentos no Sistema Eletrônico de Informações (SEI). O software acessa o sistema, navega pelos processos especificados, identifica documentos do tipo "Termo" e extrai dados estruturados de tabelas contidas nesses documentos.

## Funcionalidades Principais

### 1. Acesso Automatizado ao SEI

- Utiliza Selenium para acessar o portal SEI da
...
- Acesso autorizado ao sistema SEI da  
...
- Depende da estrutura atual do SEI da  ; mudanças na interface podem requerer ajustes
